package com.fukaimei.metalslug;
...
import com.fukaimei.metalslug.comp.MonsterManager;
import com.fukaimei.metalslug.comp.Player;
...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
    public static final Player player = new Player("圣斗士", Player.MAX_HP);
